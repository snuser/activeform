import Vue from 'vue'
import VueValidator  from  '../node_modules/vue-validator/dist/vue-validator.js'
import gomeplus from './gomeplus/gomeplus.js'
Vue.use(VueValidator)
import activeformModel from './activeform.js';
...
var activeform = new activeformModel({
  'el':'#app',
},metaProvider
);
activeform.render()
...
$('#btn-save').on('click',function(){
  activeform.validate();
  if(activeform.hasError()){
    console.log(activeform.getErrors())
  }else{
    console.log("save",activeform.getData())
  }
})
